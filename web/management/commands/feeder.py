...
from scripts.parse_utils import parse_message, add_to_db, parse_message_v2, insert_to_db
import logging, pytz
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--from_ts', default='2020-01-01_00:00:00',
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            for user in User.objects.filter(is_active=True,is_staff=False,is_superuser=False).all():
                ...
                last_fetched_ts = datetime.strptime(last_fetched_ts, "%Y-%m-%d_%H:%M:%S")
